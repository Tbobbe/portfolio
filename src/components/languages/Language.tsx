...
const Language = ({data}: {data: LanguageObject}) => {
    ...
    return (
        <div className={` 2xl:h-[60rem] 2xl:flex-grow-0 flex-grow  2xl:w-[40%] w-[70%] mb-[5rem] bg-[#F4F1DE] rounded-xl 2xl:float-left mx-auto 2xl:ml-[5%] 2xl:mr-[5%] p-10 border-8 border-[#3D405B] `} >
